package com.gradu.friend.util;

import com.gradu.friend.enums.ApplicationTypeEnum;
...
public class HttpClientUtil {
    ...
    public String getData(String url, ApplicationTypeEnum type) throws IOException {
        return fetchData(createGet(url, Collections.EMPTY_LIST, type));
    }

    public String getData(String url, List<NameValuePair> params, ApplicationTypeEnum type) throws IOException {
    ...
    public String putData(String url, List<NameValuePair> params, ApplicationTypeEnum type) throws IOException {
    ...
    public String deleteData(String url, List<NameValuePair> params, ApplicationTypeEnum type) throws IOException {
        return fetchData(createDelete(url, params, type));
    }

    public String postData(String url, final HttpEntity entity, ApplicationTypeEnum type) throws IOException {
    ...
    public String postData(String url, final List<NameValuePair> params, ApplicationTypeEnum type) throws IOException {
     ...
     */
    public HttpPost createPost(String url, final List<NameValuePair> params, ApplicationTypeEnum type) throws UnsupportedEncodingException {
    ...
    public HttpPost createPost(String url, HttpEntity entity, ApplicationTypeEnum accept) {
    ...
    public HttpGet createGet(String url, final List<NameValuePair> params, ApplicationTypeEnum accept) throws IOException {
    ...
    public HttpPut createPut(String url, final List<NameValuePair> params, ApplicationTypeEnum accept) throws IOException {
    ...
    public HttpDelete createDelete(String url, final List<NameValuePair> params, ApplicationTypeEnum accept) throws IOException {
